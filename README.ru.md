# Sarpedon - образовательная платформа для обучения программированию

<div align="center">

![Sarpedon Logo](logo.png)

**Интерактивная платформа для обучения программированию с автоматической проверкой кода и инструментами для преподавателей**
...
- Тесты ключевых сценариев аутентификации, обучения и управления классом
...
Тесты охватывают аутентификацию, ролевой доступ, учебные сценарии,
инструменты преподавателя, выполнение кода и общие UI-компоненты.
Актуальный результат можно получить командой `npm test -- --run`.
...
**Сопровождающий:** [@chas36](https://github.com/chas36)
