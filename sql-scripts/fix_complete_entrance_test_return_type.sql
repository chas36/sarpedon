-- ============================================
-- Fix: Change complete_entrance_test to return JSON instead of VOID
-- ============================================
-- PostgREST may not properly expose functions that return VOID
-- Changing to return JSON makes it compatible with RPC endpoint
...
BEGIN
  ...
  RETURN json_build_object(
    'success', true,
    'score', v_score_percentage,
    'proficiency_level', v_proficiency_level,
    'proficiency_score', v_proficiency_score
  );
END;
